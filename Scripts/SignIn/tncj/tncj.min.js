...
function init() {
    return isSurge = (() => void 0 !== this.$httpClient), isQuanX = (() => void 0 !== this.$task), getdata = (t => isSurge() ? $persistentStore.read(t) : isQuanX() ? $prefs.valueForKey(t) : void 0), setdata = ((t, e) => isSurge() ? $persistentStore.write(t, e) : isQuanX() ? $prefs.setValueForKey(t, e) : void 0), msg = ((t, e, r) => {
        isSurge() && $notification.post(t, e, r), isQuanX() && $notify(t, e, r)
    }), log = (t => console.log(t)), get = ((t, e) => {
        isSurge() && $httpClient.get(t, e), isQuanX() && (t.method = "GET", $task.fetch(t).then(t => e(null, {}, t.body)))
    }), post = ((t, e) => {
        isSurge() && $httpClient.post(t, e), isQuanX() && (t.method = "POST", $task.fetch(t).then(t => e(null, {}, t.body)))
    }), done = ((t = {}) => {
        $done(t)
    }), {
        isSurge: isSurge,
...
!function (t, e) {
    ...
    var t, e, r, i, n, o, s, a = a || function (t, e) {
        var r = Object.create || function () {
            ...
            reset: function () {
                ...
                var r = this._data, i = r.words, n = r.sigBytes, o = this.blockSize, a = 4 * o, c = n / a;
    ...
    return function () {
        ...
        var e = a, r = e.lib, i = r.WordArray, n = e.enc;
        n.Base64 = {
            stringify: function (t) {
    ...
    }(Math), t = a, e = t.lib, r = e.WordArray, i = e.Hasher, n = t.algo, o = [], s = n.SHA1 = i.extend({
        _doReset: function () {
            ...
            _doReset: function () {
                ...
                for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], s = r[3], a = r[4], l = r[5], f = r[6], u = r[7], d = 0; d < 64; d++) {
                    if (d < 16) h[d] = 0 | t[e + d]; else {
                        var p = h[d - 15], v = (p << 25 | p >>> 7) ^ (p << 14 | p >>> 18) ^ p >>> 3, _ = h[d - 2],
        ...
        if ("function" == typeof ArrayBuffer) {
            var t = a, e = t.lib, r = e.WordArray, i = r.init, n = r.init = function (t) {
        ...
        var c = a, h = c.lib, l = h.WordArray, f = h.Hasher, u = c.algo,
            ...
            g = l.create([1352829926, 1548603684, 1836072691, 2053994217, 0]), B = u.RIPEMD160 = f.extend({
                _doReset: function () {
                    ...
                    var f, u, B, k, w, S, m, x, b, C, z = this._hash.words, H = y.words, A = g.words, D = d.words,
                        E = p.words, R = v.words, M = _.words;
                    S = f = z[0], m = u = z[1], x = B = z[2], b = k = z[3], C = w = z[4];
                    var F;
                    for (c = 0; c < 80; c += 1) F = f + t[a + D[c]] | 0, F += c < 16 ? e(u, B, k) + H[0] : c < 32 ? r(u, B, k) + H[1] : c < 48 ? i(u, B, k) + H[2] : c < 64 ? n(u, B, k) + H[3] : o(u, B, k) + H[4], F |= 0, F = s(F, R[c]), F = F + w | 0, f = w, w = k, k = s(B, 10), B = u, u = F, F = S + t[a + E[c]] | 0, F += c < 16 ? o(m, x, b) + A[0] : c < 32 ? n(m, x, b) + A[1] : c < 48 ? i(m, x, b) + A[2] : c < 64 ? r(m, x, b) + A[3] : e(m, x, b) + A[4], F |= 0, F = s(F, M[c]), F = F + C | 0, S = C, C = b, b = s(x, 10), x = m, m = F;
                    F = z[1] + B + b | 0, z[1] = z[2] + k + C | 0, z[2] = z[3] + w + S | 0, z[3] = z[4] + f + m | 0, z[4] = z[0] + u + x | 0, z[0] = F
                }, _doFinalize: function () {
                    var t = this._data, e = t.words, r = 8 * this._nDataBytes, i = 8 * t.sigBytes;
        ...
        var t = a, e = t.lib, r = e.Base, i = t.enc, n = i.Utf8, o = t.algo;
        o.HMAC = r.extend({
            init: function (t, e) {
        ...
        var t = a, e = t.lib, r = e.Base, i = e.WordArray, n = t.algo, o = n.SHA1, s = n.HMAC, c = n.PBKDF2 = r.extend({
            cfg: r.extend({keySize: 4, hasher: o, iterations: 1}), init: function (t) {
        ...
        var t = a, e = t.lib, r = e.WordArray, i = t.algo, n = i.SHA256, o = i.SHA224 = n.extend({
            _doReset: function () {
        ...
        var e = a, r = e.lib, i = r.WordArray, n = r.Hasher, o = e.x64, s = o.Word, c = e.algo, h = [], l = [], f = [];
        !function () {
        ...
        var d = c.SHA3 = n.extend({
            cfg: n.cfg.extend({outputLength: 512}), _doReset: function () {
                ...
                for (var c = 0; c < 24; c++) {
                    ...
                    for (d = 0; d < 5; d++) {
                        var g = u[(d + 4) % 5], B = u[(d + 1) % 5], k = B.high, w = B.low;
                    ...
                    for (var S = 1; S < 25; S++) {
                        a = r[S];
                        var m = a.high, x = a.low, b = h[S];
                        if (b < 32) p = m << b | x >>> 32 - b, v = x << b | m >>> 32 - b; else p = x << b - 32 | m >>> 64 - b, v = m << b - 32 | x >>> 64 - b;
                        var C = u[l[S]];
                        C.high = p, C.low = v
                    }
                    var z = u[0], H = r[0];
                    ...
                    for (d = 0; d < 5; d++) for (_ = 0; _ < 5; _++) {
                        S = d + 5 * _, a = r[S];
                        var A = u[S], D = u[(d + 1) % 5 + 5 * _], E = u[(d + 2) % 5 + 5 * _];
                        a.high = A.high ^ ~D.high & E.high, a.low = A.low ^ ~D.low & E.low
                    }
                    a = r[0];
                    var R = f[c];
        ...
        var e = a, r = e.lib, i = r.Hasher, n = e.x64, o = n.Word, s = n.WordArray, c = e.algo,
        ...
        var f = c.SHA512 = i.extend({
            _doReset: function () {
                ...
                for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], s = r[3], a = r[4], c = r[5], f = r[6], u = r[7], d = i.high, p = i.low, v = n.high, _ = n.low, y = o.high, g = o.low, B = s.high, k = s.low, w = a.high, S = a.low, m = c.high, x = c.low, b = f.high, C = f.low, z = u.high, H = u.low, A = d, D = p, E = v, R = _, M = y, F = g, P = B, W = k, O = w, X = S, U = m, J = x, K = b, $ = C, I = z, L = H, j = 0; j < 80; j++) {
                    var Q = l[j];
                    if (j < 16) var N = Q.high = 0 | t[e + 2 * j], T = Q.low = 0 | t[e + 2 * j + 1]; else {
                        var q = l[j - 15], Z = q.high, G = q.low,
                            V = (Z >>> 1 | G << 31) ^ (Z >>> 8 | G << 24) ^ Z >>> 7,
                            Y = (G >>> 1 | Z << 31) ^ (G >>> 8 | Z << 24) ^ (G >>> 7 | Z << 25), tt = l[j - 2],
                            et = tt.high, rt = tt.low, it = (et >>> 19 | rt << 13) ^ (et << 3 | rt >>> 29) ^ et >>> 6,
                            nt = (rt >>> 19 | et << 13) ^ (rt << 3 | et >>> 29) ^ (rt >>> 6 | et << 26), ot = l[j - 7],
                            st = ot.high, at = ot.low, ct = l[j - 16], ht = ct.high, lt = ct.low;
                        T = Y + at, N = V + st + (T >>> 0 < Y >>> 0 ? 1 : 0), T = T + nt, N = N + it + (T >>> 0 < nt >>> 0 ? 1 : 0), T = T + lt, N = N + ht + (T >>> 0 < lt >>> 0 ? 1 : 0);
                        Q.high = N, Q.low = T
                    }
                    var ft = O & U ^ ~O & K, ut = X & J ^ ~X & $, dt = A & E ^ A & M ^ E & M,
                        pt = D & R ^ D & F ^ R & F,
                        vt = (A >>> 28 | D << 4) ^ (A << 30 | D >>> 2) ^ (A << 25 | D >>> 7),
                        _t = (D >>> 28 | A << 4) ^ (D << 30 | A >>> 2) ^ (D << 25 | A >>> 7),
                        yt = (O >>> 14 | X << 18) ^ (O >>> 18 | X << 14) ^ (O << 23 | X >>> 9),
                        gt = (X >>> 14 | O << 18) ^ (X >>> 18 | O << 14) ^ (X << 23 | O >>> 9), Bt = h[j], kt = Bt.high,
                        wt = Bt.low, St = L + gt, mt = I + yt + (St >>> 0 < L >>> 0 ? 1 : 0),
                    ...
                    I = K, L = $, K = U, $ = J, U = O, J = X, X = W + St | 0, O = P + mt + (X >>> 0 < W >>> 0 ? 1 : 0) | 0, P = M, W = F, M = E, F = R, E = A, R = D, D = St + xt | 0, A = mt + bt + (D >>> 0 < St >>> 0 ? 1 : 0) | 0
                }
                p = i.low = p + D, i.high = d + A + (p >>> 0 < D >>> 0 ? 1 : 0), _ = n.low = _ + R, n.high = v + E + (_ >>> 0 < R >>> 0 ? 1 : 0), g = o.low = g + F, o.high = y + M + (g >>> 0 < F >>> 0 ? 1 : 0), k = s.low = k + W, s.high = B + P + (k >>> 0 < W >>> 0 ? 1 : 0), S = a.low = S + X, a.high = w + O + (S >>> 0 < X >>> 0 ? 1 : 0), x = c.low = x + J, c.high = m + U + (x >>> 0 < J >>> 0 ? 1 : 0), C = f.low = C + $, f.high = b + K + (C >>> 0 < $ >>> 0 ? 1 : 0), H = u.low = H + L, u.high = z + I + (H >>> 0 < L >>> 0 ? 1 : 0)
            }, _doFinalize: function () {
                var t = this._data, e = t.words, r = 8 * this._nDataBytes, i = 8 * t.sigBytes;
        ...
        var e = a, r = e.lib, i = r.Base, n = r.WordArray, o = r.BufferedBlockAlgorithm, s = e.enc,
            c = (s.Utf8, s.Base64), h = e.algo, l = h.EvpKDF, f = r.Cipher = o.extend({
                ...
                cfg: f.cfg.extend({mode: p, padding: _}), reset: function () {
                    f.reset.call(this);
                ...
                cfg: i.extend({format: B}), encrypt: function (t, e, r, i) {
                    i = this.cfg.extend(i);
                ...
                execute: function (t, e, r, i) {
                    i || (i = n.random(8));
                    var o = l.create({keySize: e + r}).compute(t, i), s = n.create(o.words.slice(e), 4 * r);
                    return o.sigBytes = 4 * e, y.create({key: o, iv: s, salt: i})
                }
            }, m = r.PasswordBasedCipher = k.extend({
                cfg: k.cfg.extend({kdf: S}), encrypt: function (t, e, r, i) {
                    i = this.cfg.extend(i);
        ...
        var e = a, r = e.lib, i = r.CipherParams, n = e.enc, o = n.Hex, s = e.format;
        s.Hex = {
            stringify: function (t) {
        ...
        var t = a, e = t.lib, r = e.BlockCipher, i = t.algo, n = [], o = [], s = [], c = [], h = [], l = [], f = [],
            u = [], d = [], p = [];
        !function () {
            ...
            for (e = 0; e < 256; e++) {
                ...
                a = a >>> 8 ^ 255 & a ^ 99, n[r] = a, o[a] = r;
                var v = t[r], _ = t[v], y = t[_], g = 257 * t[a] ^ 16843008 * a;
                s[r] = g << 24 | g >>> 8, c[r] = g << 16 | g >>> 16, h[r] = g << 8 | g >>> 24, l[r] = g;
                g = 16843009 * y ^ 65537 * _ ^ 257 * v ^ 16843008 * r;
                f[a] = g << 24 | g >>> 8, u[a] = g << 16 | g >>> 16, d[a] = g << 8 | g >>> 24, p[a] = g, r ? (r = v ^ t[t[t[y ^ v]]], i ^= t[t[i]]) : r = i = 1
            }
        }();
        var v = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], _ = i.AES = r.extend({
            _doReset: function () {
                if (!this._nRounds || this._keyPriorReset !== this._key) {
                    for (var t = this._keyPriorReset = this._key, e = t.words, r = t.sigBytes / 4, i = this._nRounds = r + 6, o = 4 * (i + 1), s = this._keySchedule = [], a = 0; a < o; a++) if (a < r) s[a] = e[a]; else {
                        var c = s[a - 1];
                        a % r ? r > 6 && a % r == 4 && (c = n[c >>> 24] << 24 | n[c >>> 16 & 255] << 16 | n[c >>> 8 & 255] << 8 | n[255 & c]) : (c = c << 8 | c >>> 24, c = n[c >>> 24] << 24 | n[c >>> 16 & 255] << 16 | n[c >>> 8 & 255] << 8 | n[255 & c], c ^= v[a / r | 0] << 24), s[a] = s[a - r] ^ c
                    }
                    for (var h = this._invKeySchedule = [], l = 0; l < o; l++) {
                        a = o - l;
                        if (l % 4) c = s[a]; else c = s[a - 4]
                        ;
                ...
                v = (a[h >>> 24] << 24 | a[l >>> 16 & 255] << 16 | a[f >>> 8 & 255] << 8 | a[255 & u]) ^ r[d++], _ = (a[l >>> 24] << 24 | a[f >>> 16 & 255] << 16 | a[u >>> 8 & 255] << 8 | a[255 & h]) ^ r[d++], y = (a[f >>> 24] << 24 | a[u >>> 16 & 255] << 16 | a[h >>> 8 & 255] << 8 | a[255 & l]) ^ r[d++], g = (a[u >>> 24] << 24 | a[h >>> 16 & 255] << 16 | a[l >>> 8 & 255] << 8 | a[255 & f]) ^ r[d++];
        ...
        var r = a, i = r.lib, n = i.WordArray, o = i.BlockCipher, s = r.algo,
            ...
            l = [1, 2, 4, 6, 8, 10, 12, 14, 15, 17, 19, 21, 23, 25, 27, 28], f = [{
                ...
                _doReset: function () {
                    ...
                    for (var o = this._subKeys = [], s = 0; s < 16; s++) {
                        var a = o[s] = [], f = l[s];
                        for (i = 0; i < 24; i++) a[i / 6 | 0] |= r[(h[i] - 1 + f) % 28] << 31 - i % 6, a[4 + (i / 6 | 0)] |= r[28 + (h[i + 24] - 1 + f) % 28] << 31 - i % 6;
                        a[0] = a[0] << 1 | a[0] >>> 31;
        ...
        var e = a, r = e.lib, i = r.StreamCipher, n = e.algo, o = n.RC4 = i.extend({
            _doReset: function () {
        ...
        function t() {
            ...
            for (r = 0; r < 8; r++) {
                var i = t[r] + e[r], n = 65535 & i, o = i >>> 16, a = ((n * n >>> 17) + n * o >>> 15) + o * o,
        ...
        var e = a, r = e.lib, i = r.StreamCipher, n = e.algo, o = [], s = [], c = [], h = n.Rabbit = i.extend({
            _doReset: function () {
        ...
        var e = a, r = e.lib, i = r.StreamCipher, n = e.algo, o = [], s = [], c = [], h = n.RabbitLegacy = i.extend({
            _doReset: function () {
...
if ($request.url.match("findQuiz")) {
    ...
    if (0 == t.errcode) {
        const e = t.data.quiz, r = t.data.answer;
